...
:global(.icon::before), :global(.icon::after) {
  content: "";
  display: block;
  left: 50%;
  position: absolute;
...
:global(.accordion) :global(.icon),
:global(.btn) :global(.icon),
:global(.toast) :global(.icon),
:global(.menu) :global(.icon) {
  vertical-align: -10%;
}
:global(.btn-lg) :global(.icon) {
  vertical-align: -15%;
}
...
.icon-sun::after, .icon-sun::before {
  content: "";
  display: block;
  box-sizing: border-box;
  position: absolute;
...
.icon-trend::after, .icon-trend::before {
  content: "";
  display: block;
  box-sizing: border-box;
  position: absolute;
