...
:global(.spectre) .tab .tab-item a:focus, :global(.spectre) .tab .tab-item a:hover {
  color: #5755d9;
}
...
.tab-item > :global(button):focus, .tab-item > :global(button):hover {
  color: #5755d9;
}
