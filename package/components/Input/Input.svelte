...
<style>
	...
	.form-label.label-sm,
	:global(.spectre) .form-label.label-xs {
		font-size: 0.7rem;
		padding: 0.1rem 0;
	}
	.form-label.label-lg,
	:global(.spectre) .form-label.label-xl {
		font-size: 0.9rem;
		padding: 0.4rem 0;
	}
	...
	.form-input.input-sm,
	:global(.spectre) .form-input.input-xs {
		font-size: 0.7rem;
		height: 1.4rem;
		padding: 0.05rem 0.3rem;
	}
	.form-input.input-lg,
	:global(.spectre) .form-input.input-xl {
		font-size: 0.9rem;
		height: 2rem;
	...
	:global(.spectre) textarea.form-input.input-xl,
	textarea.form-input.input-sm,
	:global(.spectre) textarea.form-input.input-xs {
		height: auto;
	}
	...
	:global(.spectre) .form-checkbox.input-xs,
	.form-radio.input-sm,
	...
	:global(.spectre) .form-checkbox.input-xl,
	.form-radio.input-lg,
