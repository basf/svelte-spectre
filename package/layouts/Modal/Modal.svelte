...
:global(.spectre) .modal.modal-sm .modal-container, :global(.spectre) .modal-sm .modal-container {
  max-width: 320px;
  padding: 0 0.4rem;
}
...
:global(.spectre) .modal-lg .modal-overlay, :global(.spectre) .modal-fs .modal-overlay {
