...
<script >export let horizontal = true;
export let validity = false;
</script>

<style >:global(.form-group:not(:last-child)) {
...
:global(textarea.form-input), :global(textarea.form-input.input-lg), :global(textarea.form-input.input-sm) {
  height: auto;
}
...
.has-success :global(.form-input-hint), .is-success + :global(.form-input-hint) {
  color: #32b643;
}
.has-error :global(.form-input-hint), .is-error + :global(.form-input-hint) {
  color: #e85600;
}
:global(.form-select) {
  -webkit-appearance: none;
...
:global(.form-select[size]), :global(.form-select[multiple]) {
  height: auto;
  padding: 0.25rem 0.4rem;
}
:global(.form-select[size]) :global(option), :global(.form-select[multiple]) :global(option) {
...
.has-success :global(.form-input), :global(.form-input.is-success), .has-success :global(.form-select), :global(.form-select.is-success) {
  background: #f9fdfa;
  border-color: #32b643;
}
.has-success :global(.form-input:focus), :global(.form-input.is-success:focus), .has-success :global(.form-select:focus), :global(.form-select.is-success:focus) {
  box-shadow: 0 0 0 0.1rem rgba(50, 182, 67, 0.2);
}
.has-error :global(.form-input), :global(.form-input.is-error), .has-error :global(.form-select), :global(.form-select.is-error) {
  background: #fffaf7;
  border-color: #e85600;
}
.has-error :global(.form-input:focus), :global(.form-input.is-error:focus), .has-error :global(.form-select:focus), :global(.form-select.is-error:focus) {
  box-shadow: 0 0 0 0.1rem rgba(232, 86, 0, 0.2);
}
.has-error :global(.form-checkbox) :global(.form-icon), :global(.form-checkbox.is-error) :global(.form-icon), .has-error :global(.form-radio) :global(.form-icon), :global(.form-radio.is-error) :global(.form-icon), .has-error :global(.form-switch) :global(.form-icon), :global(.form-switch.is-error) :global(.form-icon) {
  border-color: #e85600;
}
.has-error :global(.form-checkbox) :global(input:checked) + :global(.form-icon), :global(.form-checkbox.is-error) :global(input:checked) + :global(.form-icon), .has-error :global(.form-radio) :global(input:checked) + :global(.form-icon), :global(.form-radio.is-error) :global(input:checked) + :global(.form-icon), .has-error :global(.form-switch) :global(input:checked) + :global(.form-icon), :global(.form-switch.is-error) :global(input:checked) + :global(.form-icon) {
  background: #e85600;
  border-color: #e85600;
}
.has-error :global(.form-checkbox) :global(input:focus) + :global(.form-icon), :global(.form-checkbox.is-error) :global(input:focus) + :global(.form-icon), .has-error :global(.form-radio) :global(input:focus) + :global(.form-icon), :global(.form-radio.is-error) :global(input:focus) + :global(.form-icon), .has-error :global(.form-switch) :global(input:focus) + :global(.form-icon), :global(.form-switch.is-error) :global(input:focus) + :global(.form-icon) {
  box-shadow: 0 0 0 0.1rem rgba(232, 86, 0, 0.2);
  border-color: #e85600;
}
.has-error :global(.form-checkbox) :global(input:indeterminate) + :global(.form-icon), :global(.form-checkbox.is-error) :global(input:indeterminate) + :global(.form-icon) {
  background: #e85600;
  border-color: #e85600;
}
...
:global(.form-input:disabled), :global(.form-input.disabled), :global(.form-select:disabled), :global(.form-select.disabled) {
...
:global(input:disabled) + :global(.form-icon), :global(input.disabled) + :global(.form-icon) {
  background: #eef0f3;
  cursor: not-allowed;
  opacity: 0.5;
}
:global(.form-switch) :global(input:disabled) + :global(.form-icon::before), :global(.form-switch) :global(input.disabled) + :global(.form-icon::before) {
  background: #fff;
}
