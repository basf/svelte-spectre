...
<Hero offset="my-2" size="sm">
	...
	<Avatar name="AV" size="xl" badge="0">
		<img src="{base}/img/avatar-1.png" alt="Thor Odinson" />
		<img slot="sub" src="{base}/img/avatar-1.png" alt="Thor Odinson" />
	</Avatar>
</Hero>
...
<Hero offset="my-2" size="sm">
	...
	<Modal bind:open={modalVis} size="md">
		...
		<div slot="body" class="content">
			...
			<h4>Lorem ipsum</h4>
			<p>
				Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent risus leo, dictum
				in vehicula sit amet, feugiat tempus tellus. Duis quis sodales risus. Etiam euismod
				ornare consequat.
			</p>
			<p>
			...
			<p>
				De braaaiiiins apocalypsi gorger omero prefrontal cortex undead survivor fornix
				dictum mauris. Hi brains mindless mortuis limbic cortex soulless creaturas optic
				nerve.
			</p>
			<h4>Candy ipsum</h4>
			<p>
			...
			<p>
				Caerphilly swiss fromage frais. Brie cheese and wine fromage frais chalk and cheese
				danish fontina smelly cheese who moved my cheese cow.
			</p>
		</div>
