...
<p>
	Spectre provides basic styles for typography and elements, flexbox based responsive layout
	...
	<Col col="6" xs="12">
		<Card expand shadowed flat>
			...
			<Button
				slot="footer"
				variant="primary"
				href="{base}/docs/01-getting_started/01-installation/">View</Button
			>
		</Card>
	</Col>
	<Col col="6" xs="12">
