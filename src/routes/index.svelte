<Container>
	...
	<Hero offset="my-2" size="sm">
		...
		/>
		<h5>Spread = 3</h5>
		<Pagination total={90} limit={10} active={4} spread={3} />
		<h5>Spread = 5</h5>
		<Pagination total={150} limit={10} active={8} spread={5} />
		<h5>Spread = 7</h5>
		<Pagination total={250} limit={10} active={12} spread={7} />
	</Hero>
	<Hero offset="my-2" size="sm">
		<h2>Modal</h2>
		...
		<Modal bind:open={modalVis} size="md">
			...
			<div slot="body" class="content">
				...
				<p>
					Caerphilly swiss fromage frais. Brie cheese and wine fromage frais chalk and
